...
namespace CRUDRestfulAPI.Services
{
    ...
    {
        //static string SP_PREFIX = ConfigurationManager.AppSettings["SP_PREFIX"].ToString();
        string ConStr = ConfigurationManager.ConnectionStrings["ConStr"].ToString();

        public string Add(Employee objEmployee)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("pOption", OracleDbType.NVarchar2).Value = "Insert";
